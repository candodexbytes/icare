        ...
        <div id="page-wrapper" style="min-height: 140px;">    
           <div class="col-sm-12 col-md-12 graphs mrg-top clearfix">
            <div class="col-lg-12 no-pad">
                <h1 class="heading_text text-right"><span class="pull-left">Add Tenant User</span><a href="{{ url('tenant-user') }}" class="btn btn-default my_btn">Back</a></h1>
            </div>
                       ...
                       <script type="text/javascript">
                            $(document).ready(function () { 
                              //  $(".alert.alert-info").slideUp( 300 ).delay( 800 ).fadeIn( 8000 );
                                //window.location.href = "{{ url('tenant-user') }}/{{$ptd_id_user}}";
                            });
                       </script>
                    @endif
