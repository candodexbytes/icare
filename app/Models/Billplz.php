...
class Billplz extends Model
    {
         ...
         */
        public static $api_key = '323d17f7-6fa7-45b0-92a1-ce6b39c0f4d5';
        public static $x_signature = 'S-ui-SylJPK9XwhVh87lOArQ';
      ...
      public function create_collection_with_split($title = 'Payment For Rent', $mode = '')
        {
            ...
            $split_payment =  array('email' => 'smartlever.sdn.bhd@gmail.com','fixed_cut' => 100, 'split_header' => false ,'company' => 'test');   
